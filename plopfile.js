...
const themeActions = [
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/.npmignore`,
    templateFile: `plop-templates/theme/.npmignore.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/gatsby-config.js`,
    templateFile: `plop-templates/theme/gatsby-config.js.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/index.js`,
    templateFile: `plop-templates/theme/index.js.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/package.json`,
    templateFile: `plop-templates/theme/package.json.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/README.md`,
    templateFile: `plop-templates/theme/README.md.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/src/components/seo.tsx`,
    templateFile: `plop-templates/theme/seo.tsx.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/src/gatsby-plugin-theme-ui/index.js`,
    templateFile: `plop-templates/theme/theme-ui.js.hbs`,
  },
  {
    type: `add`,
    path: `themes/{{kebabCase name}}/src/hooks/use-site-metadata.tsx`,
...
const exampleActions = [
  ...
  },
  {
    ...
    templateFile: `plop-templates/theme/cypress-test.ts.hbs`,
  },
]
