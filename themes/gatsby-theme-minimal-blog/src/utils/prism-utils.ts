...
interface StyleObj { [key: string]: string }

function flattenThemeTypes(theme: PrismTheme): PrismTheme {
 ...
 */
export function themeWithCssVariables(theme: PrismTheme): { theme: PrismTheme, variables: StyleObj } {
