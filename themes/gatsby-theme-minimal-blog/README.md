...
| `latestPostsText`  | `Latest posts`                                       | Text for title on homepage (optional)                                                                      |
| `readAllPostsText` | `Read all posts`                                     | Text for link on homepage (optional)                                                                       |
| `viewAllTagsText`  | `View all tags`                                      | Text for link on blog page (optional)                                                                      |
