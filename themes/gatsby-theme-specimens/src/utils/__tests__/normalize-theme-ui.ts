import normalizeThemeUI from "../normalize-theme-ui"
...
describe(`Normalize ThemeUI`, () => {
  test(`should transform with default options (omitting values)`, () => {
    expect(normalizeThemeUI({ colors: exampleTheme })).toMatchInlineSnapshot(`
      Array [
        Object {
          "color": "#000",
          "name": "black",
  ...
  test(`should transform without omitting fields`, () => {
    expect(normalizeThemeUI({ colors: exampleTheme, omit: [] })).toMatchInlineSnapshot(`
      Array [
        Object {
          "color": "transparent",
          "name": "transparent",
