...
export interface EmmaProjectsProps {
	projects: {
		color: string
		slug: string
		title: string
			...
			<Layout>
				<Container>
					<Themed.p>
						...
						Thanks for using
						{` `}
						<b>@lekoarts/gatsby-theme-emma</b>
						. You currently don't have any content in your
						{` `}
						<i>projects</i>
						{` `}
						folder - that's why this page displays a placeholder text. Head over to the
						{` `}
