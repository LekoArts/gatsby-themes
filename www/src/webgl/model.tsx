...
import { useGLTFLoader } from "@react-three/drei/useGLTFLoader"
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTFLoader(`/model/dracoGatsby.gltf`, true) as GLTFResult
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[0.21, 8.75, 59.69]}>
        <mesh material={materials.Gray} geometry={nodes.Block_Above.geometry} position={[-0.28, 0.23, 0.6]}>
          <meshPhysicalMaterial attach="material" color={materials.Gray.color} />
        </mesh>
        <mesh material={materials.Gatsby} geometry={nodes.Logos.geometry} position={[0.28, 5.76, -0.6]}>
          <meshPhysicalMaterial attach="material" color={materials.Gatsby.color} />
        </mesh>
        <mesh material={materials.Plurble} geometry={nodes.base.geometry} position={[-0.05, -5.76, 0.01]}>
          <meshPhysicalMaterial attach="material" color={materials.Plurble.color} />
        </mesh>
      </group>
      <group position={[-59.45, 4.97, 0.07]}>
        <mesh material={materials.Plurble} geometry={nodes.base.geometry} position={[-0.09, -1.98, -0.07]}>
          <meshPhysicalMaterial attach="material" color={materials.Plurble.color} />
        </mesh>
        <mesh material={materials.Green} geometry={nodes.Braces.geometry} position={[0.09, 1.98, 0.07]}>
          <meshPhysicalMaterial attach="material" color={materials.Green.color} />
        </mesh>
      </group>
      <group position={[0.01, 7.39, -59.99]}>
        <mesh material={materials.Plurble} geometry={nodes.base.geometry} position={[0.15, -4.4, 0.3]}>
          <meshPhysicalMaterial attach="material" color={materials.Plurble.color} />
        </mesh>
        <mesh material={materials.Orange} geometry={nodes.Database.geometry} position={[-0.15, 4.4, -0.3]}>
          <meshPhysicalMaterial attach="material" color={materials.Orange.color} />
        </mesh>
      </group>
        ...
        <group position={[10.82, -19.57, 0]}>
          <group position={[-8.66, 2.1, 0.65]} rotation={[-1.57, 0, 0]}>
            <mesh
              ...
              rotation={[1.57, 0, 0]}
            >
              <meshPhysicalMaterial attach="material" color={materials.Magenta.color} />
            </mesh>
            <mesh
              ...
              rotation={[1.57, 0, 0]}
            >
              <meshPhysicalMaterial attach="material" color={materials.Red.color} />
            </mesh>
            <mesh
              ...
              rotation={[1.57, 0, 0]}
            >
              <meshPhysicalMaterial attach="material" color={materials.Blue.color} />
            </mesh>
          </group>
          <group position={[17.45, 2.37, 0]}>
            ...
            <mesh material={materials.Magenta} geometry={nodes.Triangle1.geometry} position={[-2.98, 0.61, 3.31]}>
              <meshPhysicalMaterial attach="material" color={materials.Magenta.color} />
            </mesh>
            <mesh material={materials.Red} geometry={nodes.Hexagon1.geometry} position={[2.98, 0.7, 2.26]}>
              <meshPhysicalMaterial attach="material" color={materials.Red.color} />
            </mesh>
          ...
          <mesh material={materials.Plurble} geometry={nodes.Belt.geometry} position={[-1.72, -3.07, 0.84]}>
            <meshPhysicalMaterial attach="material" color={materials.Plurble.color} />
          </mesh>
        </group>
