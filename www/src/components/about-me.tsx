  ...
  <section data-name="about-me" sx={{ position: `relative`, py: 6 }}>
    ...
    <Container sx={{ mt: [6, 7], position: `relative` }}>
      <Box
        sx={{
          borderRadius: `xl`,
          variant: `gradients.indigo`,
          p: [4, 4, 5],
          color: `white`,
          boxShadow: (t: { colors: { [key: string]: any[] } }) => `0px 20px 25px ${t.colors.indigo[2]}`,
        }}
      >
        <h3
          sx={{
        ...
        <Styled.p sx={{ textShadow: `0 1px 1px rgba(0, 0, 0, 0.2)` }}>
          ...
          ('cause I don't drink coffee), or consider supporting me on Patreon. The latter will allow me to allocate more
          time to maintaining these themes. Thanks for using my themes!{` `}
