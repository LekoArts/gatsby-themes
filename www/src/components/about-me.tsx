...
/** @jsx jsx */
import { Box, Container, Flex, get, useColorMode } from "theme-ui"
			...
			<Container>
				<div sx={{ maxWidth: `760px` }}>
					...
					<Themed.p>
						...
						{` `}
						<Themed.a href="https://www.lekoarts.de">Homepage</Themed.a>
						{` `}
						where I blog about React,
						...
						<Themed.a href="https://www.lekoarts.de/art">Art</Themed.a>
						{` `}
						page.
					</Themed.p>
					<Themed.p>
						...
						{` `}
						<Themed.a href="https://theme-ui.com/">Theme UI</Themed.a>
						{` `}
						— which makes them really customizable 🎉.
					</Themed.p>
					<Themed.p>
