/** @jsx jsx */
import { Flex, Box, jsx, Themed, Container, useColorMode, ThemeUIStyleObject } from "theme-ui"
...
const cardStyle: ThemeUIStyleObject = {
  position: `relative`,
...
const Listing = () => {
  ...
  let buttonStyles: ThemeUIStyleObject = {}
  let overlayStyles: ThemeUIStyleObject = {}
